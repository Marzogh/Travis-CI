...
export MAIN_PLATFORMS='declare -A main_platforms=( [uno]="arduino:avr:uno" [micro]="arduino:avr:micro" [fio]="arduino:avr:fio" [mega]="arduino:avr:mega" [due]="arduino:sam:arduino_due_x" [esp8266]="esp8266:esp8266:huzzah" [leonardo]="arduino:avr:leonardo" )'
