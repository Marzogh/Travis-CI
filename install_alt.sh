...
# Removing Support for Zero and Simblee : @boseji <salearj@hotmail.com>
export MAIN_PLATFORMS='declare -A main_platforms=( [uno]="arduino:avr:uno" [due]="arduino:sam:arduino_due_x" [esp8266]="esp8266:esp8266:huzzah" [leonardo]="arduino:avr:leonardo" [mega]="arduino:avr:mega" )'
...
# Removing Support for Zero : @boseji <salearj@hotmail.com>
export AUX_PLATFORMS='declare -A aux_platforms=( [trinket]="adafruit:avr:trinket3" [gemma]="arduino:avr:gemma" [micro]="arduino:avr:micro" [fio]="arduino:avr:fio"  [rtl8195a]="realtek:ameba:ameba_rtl8195a" [rtl8710]="realtek:ameba:ameba_rtl8710"  )'
...
# install the due, esp8266, adafruit & realtek board packages
...
# Removing Support for Zero as it takes very long : @boseji <salearj@hotmail.com>
#echo -n "ZERO: "
...
# Removing Support for SIMBLEE as it some times has in-compatibility : @boseji <salearj@hotmail.com>
#echo -n "SIMBLEE: "
